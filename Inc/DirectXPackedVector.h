...
struct XMCOLOR
{
    ...
    constexpr XMCOLOR(uint32_t Color) : c(Color) {}
...
struct XMHALF2
{
    ...
    explicit constexpr XMHALF2(uint32_t Packed) : v(Packed) {}
    constexpr XMHALF2(HALF _x, HALF _y) : x(_x), y(_y) {}
...
struct XMSHORTN2
{
    ...
    explicit constexpr XMSHORTN2(uint32_t Packed) : v(Packed) {}
    constexpr XMSHORTN2(int16_t _x, int16_t _y) : x(_x), y(_y) {}
...
struct XMSHORT2
{
    ...
    explicit constexpr XMSHORT2(uint32_t Packed) : v(Packed) {}
    constexpr XMSHORT2(int16_t _x, int16_t _y) : x(_x), y(_y) {}
...
struct XMUSHORTN2
{
    ...
    explicit constexpr XMUSHORTN2(uint32_t Packed) : v(Packed) {}
    constexpr XMUSHORTN2(uint16_t _x, uint16_t _y) : x(_x), y(_y) {}
...
struct XMUSHORT2
{
    ...
    explicit constexpr XMUSHORT2(uint32_t Packed) : v(Packed) {}
    constexpr XMUSHORT2(uint16_t _x, uint16_t _y) : x(_x), y(_y) {}
...
struct XMBYTEN2
{
    ...
    explicit constexpr XMBYTEN2(uint16_t Packed) : v(Packed) {}
    constexpr XMBYTEN2(int8_t _x, int8_t _y) : x(_x), y(_y) {}
...
struct XMBYTE2
{
    ...
    explicit constexpr XMBYTE2(uint16_t Packed) : v(Packed) {}
    constexpr XMBYTE2(int8_t _x, int8_t _y) : x(_x), y(_y) {}
...
struct XMUBYTEN2
{
    ...
    explicit constexpr XMUBYTEN2(uint16_t Packed) : v(Packed) {}
    constexpr XMUBYTEN2(uint8_t _x, uint8_t _y) : x(_x), y(_y) {}
...
struct XMUBYTE2
{
    ...
    explicit constexpr XMUBYTE2(uint16_t Packed) : v(Packed) {}
    constexpr XMUBYTE2(uint8_t _x, uint8_t _y) : x(_x), y(_y) {}
...
struct XMU565
{
    ...
    explicit constexpr XMU565(uint16_t Packed) : v(Packed) {}
    constexpr XMU565(uint8_t _x, uint8_t _y, uint8_t _z) : x(_x), y(_y), z(_z) {}
...
struct XMFLOAT3PK
{
    ...
    explicit constexpr XMFLOAT3PK(uint32_t Packed) : v(Packed) {}
...
struct XMFLOAT3SE
{
    ...
    explicit constexpr XMFLOAT3SE(uint32_t Packed) : v(Packed) {}
...
struct XMHALF4
{
    ...
    explicit constexpr XMHALF4(uint64_t Packed) : v(Packed) {}
    constexpr XMHALF4(HALF _x, HALF _y, HALF _z, HALF _w) : x(_x), y(_y), z(_z), w(_w) {}
...
struct XMSHORTN4
{
    ...
    explicit constexpr XMSHORTN4(uint64_t Packed) : v(Packed) {}
    constexpr XMSHORTN4(int16_t _x, int16_t _y, int16_t _z, int16_t _w) : x(_x), y(_y), z(_z), w(_w) {}
...
struct XMSHORT4
{
    ...
    explicit constexpr XMSHORT4(uint64_t Packed) : v(Packed) {}
    constexpr XMSHORT4(int16_t _x, int16_t _y, int16_t _z, int16_t _w) : x(_x), y(_y), z(_z), w(_w) {}
...
struct XMUSHORTN4
{
    ...
    explicit constexpr XMUSHORTN4(uint64_t Packed) : v(Packed) {}
    constexpr XMUSHORTN4(uint16_t _x, uint16_t _y, uint16_t _z, uint16_t _w) : x(_x), y(_y), z(_z), w(_w) {}
...
struct XMUSHORT4
{
    ...
    explicit constexpr XMUSHORT4(uint64_t Packed) : v(Packed) {}
    constexpr XMUSHORT4(uint16_t _x, uint16_t _y, uint16_t _z, uint16_t _w) : x(_x), y(_y), z(_z), w(_w) {}
...
// most significant bits and the x component in the least significant bits
// (W2Z10Y10X10): [32] wwzzzzzz zzzzyyyy yyyyyyxx xxxxxxxx [0]
struct [[deprecated("This is deprecated and will be removed in a future version.")]] XMXDEC4
{
    union
    {
        struct
    ...
    explicit constexpr XMXDEC4(uint32_t Packed) : v(Packed) {}
...
// most significant bits and the x component in the least significant bits
// (W2Z10Y10X10): [32] wwzzzzzz zzzzyyyy yyyyyyxx xxxxxxxx [0]
struct [[deprecated("This is deprecated and will be removed in a future version.")]] XMDECN4
{
    union
    {
        struct
    ...
    explicit constexpr XMDECN4(uint32_t Packed) : v(Packed) {}
...
// most significant bits and the x component in the least significant bits
// (W2Z10Y10X10): [32] wwzzzzzz zzzzyyyy yyyyyyxx xxxxxxxx [0]
struct [[deprecated("This is deprecated and will be removed in a future version.")]] XMDEC4
{
    union
    {
        struct
    ...
    explicit constexpr XMDEC4(uint32_t Packed) : v(Packed) {}
...
struct XMUDECN4
{
    ...
    explicit constexpr XMUDECN4(uint32_t Packed) : v(Packed) {}
...
struct XMUDEC4
{
    ...
    explicit constexpr XMUDEC4(uint32_t Packed) : v(Packed) {}
...
struct XMBYTEN4
{
    ...
    constexpr XMBYTEN4(int8_t _x, int8_t _y, int8_t _z, int8_t _w) : x(_x), y(_y), z(_z), w(_w) {}
    explicit constexpr XMBYTEN4(uint32_t Packed) : v(Packed) {}
...
struct XMBYTE4
{
    ...
    constexpr XMBYTE4(int8_t _x, int8_t _y, int8_t _z, int8_t _w) : x(_x), y(_y), z(_z), w(_w) {}
    explicit constexpr XMBYTE4(uint32_t Packed) : v(Packed) {}
...
struct XMUBYTEN4
{
    ...
    constexpr XMUBYTEN4(uint8_t _x, uint8_t _y, uint8_t _z, uint8_t _w) : x(_x), y(_y), z(_z), w(_w) {}
    explicit constexpr XMUBYTEN4(uint32_t Packed) : v(Packed) {}
...
struct XMUBYTE4
{
    ...
    constexpr XMUBYTE4(uint8_t _x, uint8_t _y, uint8_t _z, uint8_t _w) : x(_x), y(_y), z(_z), w(_w) {}
    explicit constexpr XMUBYTE4(uint32_t Packed) : v(Packed) {}
...
struct XMUNIBBLE4
{
    ...
    explicit constexpr XMUNIBBLE4(uint16_t Packed) : v(Packed) {}
    constexpr XMUNIBBLE4(uint8_t _x, uint8_t _y, uint8_t _z, uint8_t _w) : x(_x), y(_y), z(_z), w(_w) {}
...
struct XMU555
{
    ...
    explicit constexpr XMU555(uint16_t Packed) : v(Packed) {}
    constexpr XMU555(uint8_t _x, uint8_t _y, uint8_t _z, bool _w) : x(_x), y(_y), z(_z), w(_w ? 0x1 : 0) {}
...
[[deprecated("This is deprecated and will be removed in a future version.")]] XMVECTOR XM_CALLCONV XMLoadDecN4(_In_ const XMDECN4* pSource);
[[deprecated("This is deprecated and will be removed in a future version.")]] XMVECTOR XM_CALLCONV XMLoadDec4(_In_ const XMDEC4* pSource);
[[deprecated("This is deprecated and will be removed in a future version.")]] XMVECTOR XM_CALLCONV XMLoadXDec4(_In_ const XMXDEC4* pSource);
#ifdef __GNUC__
...
[[deprecated("This is deprecated and will be removed in a future version.")]] void XM_CALLCONV XMStoreDecN4(_Out_ XMDECN4* pDestination, _In_ FXMVECTOR V);
[[deprecated("This is deprecated and will be removed in a future version.")]] void XM_CALLCONV XMStoreDec4(_Out_ XMDEC4* pDestination, _In_ FXMVECTOR V);
[[deprecated("This is deprecated and will be removed in a future version.")]] void XM_CALLCONV XMStoreXDec4(_Out_ XMXDEC4* pDestination, _In_ FXMVECTOR V);
#ifdef __GNUC__
#pragma GCC diagnostic pop
#endif
#pragma warning(pop)
